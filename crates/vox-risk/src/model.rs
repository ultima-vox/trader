...
pub struct RiskSnapshot {
    ...
    pub instrument_tradable: bool,
    pub instrument_lot_size: i64,
    ...
    pub gross_exposure_nanos: Option<i128>,
    pub net_exposure_nanos: Option<i128>,
    pub instrument_exposure_nanos: Option<i128>,
